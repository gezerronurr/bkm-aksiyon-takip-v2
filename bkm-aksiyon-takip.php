...
require_once BKM_AKSIYON_PLUGIN_DIR . 'public/shortcodes/aksiyon-takipx-shortcode.php';
    $this->shortcodes = new BKM_Aksiyon_TakipX_Shortcode('bkm-aksiyon-takip', BKM_AKSIYON_VERSION);
}
    ...
    private function register_shortcodes() {
        require_once plugin_dir_path(__FILE__) . 'public/shortcodes/aksiyon-takipx-shortcode.php';
        new BKM_Aksiyon_TakipX_Shortcode($this->get_plugin_name(), $this->get_version());
    }
}
